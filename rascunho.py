...
def get_attribute():
    with webdriver.Chrome() as driver:
        ...
        #/html/body/div[3]/div/div[6]/section/div/div[1]/svg/g/g[23]/rect[2]    RETANGULO COM BOLSAS
        retangulo = driver.find_element(By.XPATH, '//body/div[3]/div/div[6]/section/div/div[1]/*[name()="svg" and @class = "svg-content"]/*[name()="g"]/*[name()="g"][16]/*[local-name()="rect"][2]')
        # /html/body/div[3]/div/div[6]/section/div/div[1]/svg/g/g[16]/rect[2]
        time.sleep(1.5)
        verifica_nulo = retangulo.get_attribute('height')
        if verifica_nulo == '0':
            text_bolsas = 'Bolsas: 0'
